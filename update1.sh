...
if [ "$ARCH" = "aarch64" ]; then
  ...
  SNAPSHOT_URL="https://www.rocrail.online/rocrail-snapshot/Rocrail-PiOS11-ARM64.zip"
elif [ "$ARCH" = "armv7l" ]; then
  echo "[INFO] 32-Bit System erkannt – lade ARMHF-Version"
  SNAPSHOT_URL="https://www.rocrail.online/rocrail-snapshot/Rocrail-PiOS11-ARM.zip"
else
